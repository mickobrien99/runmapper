...
public class DBAdapter extends SQLiteOpenHelper {
	...
	private static final String DB_NAME = "RunMapper.sqlite";
	...
	*/
	...
	public boolean updateRecordInDB(String tableName,ContentValues initialValues, String whereClause, String whereArgs[]) {
		...
		boolean response=myDataBase.update(tableName, initialValues, whereClause,	whereArgs) > 0;				
		//myDataBase.close();
		return response;
	...
	public int updateRecordsInDB(String tableName, ContentValues initialValues, String whereClause, String whereArgs[]) {
		...
		int response= myDataBase.update(tableName, initialValues, whereClause, whereArgs);		
	...
	public int deleteRecordInDB(String tableName, String whereClause,String[] whereArgs) {
		int response=myDataBase.delete(tableName, whereClause, whereArgs);
		
		return response;
	}

	public int deleteAllRecordInDB(String tableName) {
		
		int response =myDataBase.delete(tableName,"",null);
		return response;
	}
	...
	public Cursor selectRecordsFromDB(String query, String[] selectionArgs) {
		...
		Cursor response=myDataBase.rawQuery(query, selectionArgs);
		return response;		
	}
